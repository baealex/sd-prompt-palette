...
## Learnings
- [L-20260228-live-images-orchestration-split](chunks/L-20260228-live-images-orchestration-split.md) Keeping watcher runtime and ingest/library workflows outside the service class reduced coupling and made the orchestration file easier to scan. | #backend #orchestration #refactor (2026-02-28)
- [L-20260228-live-images-service-split](chunks/L-20260228-live-images-service-split.md) Service class bloat widened diffs; splitting pure helpers and narrowing guard checks to signature lines improved practical guard fit. | #backend #guardrails #refactor (2026-02-28)
